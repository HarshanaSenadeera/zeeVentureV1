                    ...
                    <div className="row g-5">
                        <div className="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                            <div
                                ...
                                <p className="m-0">Amet justo dolor lorem kasd amet magna sea stet eos vero lorem ipsum
                                    dolore sed</p>
                        ...
                        <div className="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                            <div
                                ...
                                <p className="text-white mb-3">Clita ipsum magna kasd rebum at ipsum amet dolor justo
