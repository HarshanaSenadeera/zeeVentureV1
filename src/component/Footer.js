                        ...
                        <div className="col-lg-4 col-md-6 footer-about">
                            <div className="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                                <a href="index.html" className="navbar-brand">
                                    <h1 className="m-0 text-white"><img src={logo} style={{height:'80px'}}/>Zeeventures
                                    </h1>
                                </a>
                            ...
                            <div className="row gx-5">
                                <div className="col-lg-4 col-md-12 pt-5 mb-5">
                                    ...
                                    <div className="d-flex mb-2">
                                        ...
                                        <p className="mb-0">zeeventures.info@gmail.com</p>
                                    </div>
                                    <div className="d-flex mb-2">
                                ...
                                <div className="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                                    ...
                                    <div className="link-animated d-flex flex-column justify-content-start">
                                        ...
                                        <a className="text-light mb-2" href="service"><i className="bi bi-arrow-right text-primary me-2"></i>Our Services</a>
                                        <a className="text-light mb-2" href="member"><i className="bi bi-arrow-right text-primary me-2"></i>Meet The Team</a>
                    ...
                    <div className="row justify-content-end">
                        <div className="col-lg-8 col-md-6">
                            <div className="d-flex align-items-center justify-content-center" style={{height: '75px'}}>
                                <p className="mb-0">&copy; <a className="text-white border-bottom" href="#">zeeventures</a>. All Rights Reserved.
                                    Designed by <a className="text-white border-bottom" href="/">zeeventures</a></p>
                            </div>
                        </div>
                    </div>
                </div>
